...
public class LoginController {
    ...
    @PostMapping("/login")
    public String loginV3(@Valid @ModelAttribute LoginForm form, BindingResult bindingResult, HttpServletResponse res, HttpServletRequest req) {
        ...
        //로그인 성공 처리
        // 세션이 있으면 있는 세션 반환, 없다면 신규 세션을 생성한다
    ...
    public String logoutV3(HttpServletRequest req) {
        ...
        if(session != null) {
            session.invalidate(); // 세션을 확인하고, 날릴지 판단한다
        }
        return "redirect:/";
    }
